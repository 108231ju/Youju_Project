...
<meta charset="UTF-8">
<title>Index</title>
<link rel="stylesheet" href="/resources/user/CSS/product1.css" />
<link rel="stylesheet" href="/resources/user/CSS/product2.css" />
<link rel="stylesheet" href="/resources/user/CSS/product3.css" />
<script language="javascript" src="/resources/user/JS/product.js"
...
<body>
	...
	<div id="menu1">
		<nav>
			<ul>
				<li id="info1"
					onclick="location.href='/user/product1?pcode=${view.pcode}'">상품정보</li>
				<li id="review1"
					onclick="location.href='/user/product2?pcode=${view.pcode}'">리뷰</li>
				<li id="QandA1"
					onclick="location.href='/user/product3?pcode=${view.pcode}'">Q&A</li>
