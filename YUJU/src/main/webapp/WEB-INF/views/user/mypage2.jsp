...
<head>
    ...
    <script language="javascript" src="/resources/user/JS/mypage2.js" type="text/javascript"></script>
        ...
        <nav id="pagemenu">
            <ul>
                <li id="order2" onclick="acyncMovePage2();"><img
                        ...
                        배송조회</a></li>
                <li id="info2" onclick="acyncMovePage1();"><img src="https://www.brandi.co.kr/static/3.47.4/images/ic-my-point-s@3x.png"><br><a>내
                        정보</a></li>
                ...
                <li id="QandA2" onclick="acyncMovePage4();"><img src="https://www.brandi.co.kr/static/3.47.4/images/ic-mypage-qna-s@3x.png"><br><a>Q
                        & A</a></li>
