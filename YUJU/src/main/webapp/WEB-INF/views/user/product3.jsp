...
<head>
    <meta charset="UTF-8">
    <title>Index</title>
    <link rel="stylesheet" href="/resources/user/CSS/product3.css" />
  ...
  <div id="content">
        ...
        <div id="s_list4">
            ...
            <table>
				...
				<c:forEach items="${QandA}" var="QandA">
				<tbody>
					<tr>
                        <td>${QandA.mid}</td>
                        <td>[${QandA.sname}]<br>${QandA.pname}</td>
                        <td>${QandA.state}</td>
                        <td>${QandA.question}</td>
                        <td><fmt:formatDate pattern="yyyy.MM.dd" value="${QandA.updatedate}"/></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
                        <td id="">ㄴ답변&nbsp&nbsp</td>
                        <td>${QandA.answer}</td>
                        <td></td>                       
                    </tr>
        ...
        <button id="qwrite" onclick="location.href='/user/qwrite?pcode=${view.pcode}'">작성하기</button>
    </div>
